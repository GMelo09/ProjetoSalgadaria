...
<div class="page-header">
  <div class="container">
    <div class="breadcrumb">
      <a href="../index.php">Início</a><span>/</span><span>Carrinho</span>
    </div>
    <h1>🛒 Meu Carrinho</h1>
...
function renderCart() {
  ...
  document.getElementById('cartEmpty').style.display   = items.length === 0 ? 'block' : 'none';
  document.getElementById('cartContent').style.display = items.length === 0 ? 'none'  : 'block';
...
function cartRemove(idx) {
  Cart.remove(idx);
  renderCart();
  Swal.fire({ toast:true, position:'top-end', icon:'warning', title:'Item removido.',
...
function clearCart() {
  Swal.fire({
    ...
    Cart.clear();
    renderCart();
    Swal.fire({ toast:true, position:'top-end', icon:'success', title:'Carrinho limpo!',
