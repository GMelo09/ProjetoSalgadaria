...
$produtos   = $produtoObj->ListarPorCategoria(1);
...
<div class="page-header">
  <div class="container">
    <div class="breadcrumb">
      <a href="../index.php">Início</a><span>/</span><span>Salgados</span>
    </div>
    <h1>🥟 Salgados</h1>
    <p><?= count($produtos) ?> opções artesanais fresquinhas</p>
  </div>
</div>
...
<section class="section-sm section-rose">
  <div class="container text-center">
    ...
    <p class="text-muted mb-3">Monte um pacote e escolha vários sabores de uma vez.</p>
