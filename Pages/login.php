...
// Mensagens de erro via query string
$erros = [
  ...
  <div class="auth-main">
    <div style="max-width:400px;width:100%;margin:0 auto;">
      ...
      <div class="auth-tabs" role="tablist">
        <button class="auth-tab active" id="tabLoginBtn" onclick="switchTab('login')">
          <i class="bi bi-box-arrow-in-right"></i> Entrar
        </button>
        <button class="auth-tab" id="tabCadBtn" onclick="switchTab('cadastro')">
...
document.getElementById('cadSenha2').addEventListener('input', function() {
  const match = this.value === document.getElementById('cadSenha').value;
  document.getElementById('senhaErro').style.display = (!match && this.value) ? 'block' : 'none';
});

document.getElementById('cadTel').addEventListener('input', function() {
...
// Abre aba correta conforme query string e exibe erro via SweetAlert
const params = new URLSearchParams(location.search);
if (params.get('tab') === 'cadastro') switchTab('cadastro');
...
Swal.fire({
  ...
  position: 'top-end',
  icon: 'success',
  title: '<?= addslashes($flash['mensagem']) ?>',
  showConfirmButton: false,
  timer: 3500,
  timerProgressBar: true,
});
